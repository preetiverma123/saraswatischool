                            ...
                            <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_payment">
                                <div class="x_content"> 
                                   ...
                                   <?php if($payment->salary_type == 'monthly'){ ?>
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="over_time_total_hour"><?php echo $this->lang->line('over_time_total_hour'); ?></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="over_time_amount"><?php echo $this->lang->line('over_time_amount'); ?></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                   ...
                                   <?php }else{ ?>                              
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12"  name="hourly_rate"  id="add_hourly_rate" value="<?php echo $payment->hourly_rate; ?>" placeholder="<?php echo $this->lang->line('hourly_rate'); ?>" readonly="readonly" type="number">
                                            <div class="help-block"><?php echo form_error('hourly_rate'); ?></div>
                                        </div>
                                    </div> 
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="total_hour"><?php echo $this->lang->line('total_hour'); ?> <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12 fn_add_claculate"  name="total_hour"  id="add_total_hour" value="" placeholder="<?php echo $this->lang->line('total_hour'); ?>" required="required" type="number">
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="bonus"><?php echo $this->lang->line('bonus'); ?></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12 fn_add_claculate"  name="bonus"  id="add_bonus" value="" placeholder="<?php echo $this->lang->line('bonus'); ?>"  type="number">
                                            <div class="help-block"><?php echo form_error('bonus'); ?></div>
                                        </div>
                                    </div> 

                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="penalty"><?php echo $this->lang->line('penalty'); ?></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12 fn_add_claculate"  name="penalty"  id="add_penalty" value="" placeholder="<?php echo $this->lang->line('penalty'); ?>" type="number">
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="salary_month"><?php echo $this->lang->line('month'); ?> <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12 "  name="salary_month"  id="add_salary_month" value="" placeholder="<?php echo $this->lang->line('month'); ?>" required="required" type="text">
                                ...
                                <!-- For cheque End-->
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="expenditure_head_id"><?php echo $this->lang->line('expenditure_head'); ?><span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                               ...
                               <?php echo form_open(site_url('payroll/payment/edit/'.$edit_payment->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                   ...
                                   <?php if($payment->salary_type == 'monthly'){ ?>
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="over_time_total_hour"><?php echo $this->lang->line('over_time_total_hour'); ?></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12 fn_edit_claculate"  name="over_time_total_hour"  id="edit_over_time_total_hour" value="<?php echo $edit_payment->over_time_total_hour; ?>" placeholder="<?php echo $this->lang->line('over_time_total_hour'); ?>" type="number">
                                            <div class="help-block"><?php echo form_error('over_time_total_hour'); ?></div>
                                        </div>
                                    </div> 
                                    <div class="item form-group">
                                   ...
                                   <?php }else{ ?>                              
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="total_hour"><?php echo $this->lang->line('total_hour'); ?> <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12 fn_edit_claculate"  name="total_hour"  id="edit_total_hour" value="<?php echo $edit_payment->total_hour; ?>" placeholder="<?php echo $this->lang->line('total_hour'); ?>" required="required" type="number">
                                            <div class="help-block"><?php echo form_error('total_hour'); ?></div>
                                        </div>
                                    </div> 
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="bonus"><?php echo $this->lang->line('bonus'); ?></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12 fn_edit_claculate"  name="bonus"  id="edit_bonus" value="<?php echo $edit_payment->bonus; ?>" placeholder="<?php echo $this->lang->line('bonus'); ?>"  type="number">
                                            <div class="help-block"><?php echo form_error('bonus'); ?></div>
                                        </div>
                                    </div> 
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="penalty"><?php echo $this->lang->line('penalty'); ?></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12 fn_edit_claculate"  name="penalty"  id="edit_penalty" value="<?php echo $edit_payment->penalty; ?>" placeholder="<?php echo $this->lang->line('penalty'); ?>" type="number">
                                            <div class="help-block"><?php echo form_error('penalty'); ?></div>
                                        </div>
                                    </div> 
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="salary_month"><?php echo $this->lang->line('month'); ?> <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12 "  name="salary_month"  id="edit_salary_month" value="<?php echo $edit_payment->salary_month; ?>" placeholder="<?php echo $this->lang->line('month'); ?>" required="required" type="text">
                                            <div class="help-block"><?php echo form_error('salary_month'); ?></div>
                                        </div>
                                    </div> 
                                    ...
                                    <!-- For cheque Start-->
                                    <div class=" fn_cheque <?php if(isset($edit_payment) && $edit_payment->payment_method == 'cash'){ echo 'display'; } ?>" >
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="bank_name"><?php echo $this->lang->line('bank'); ?> <?php echo $this->lang->line('name'); ?><span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input  class="form-control col-md-7 col-xs-12"  name="bank_name"  id="edit_bank_name" value="<?php echo $edit_payment->bank_name; ?>" placeholder="<?php echo $this->lang->line('bank'); ?> <?php echo $this->lang->line('name'); ?>"  type="text">
                                                <div class="help-block"><?php echo form_error('bank_name'); ?></div>
                                            </div>
                                        </div> 
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input  class="form-control col-md-7 col-xs-12"  name="cheque_no"  id="edit_cheque_no" value="<?php echo $edit_payment->cheque_no; ?>" placeholder="<?php echo $this->lang->line('cheque'); ?> <?php echo $this->lang->line('number'); ?>"  type="text">
                                                <div class="help-block"><?php echo form_error('cheque_no'); ?></div>
                                            </div>
                                        </div>
                                    </div>
