                    ...
                    <br/>
                     ...
                     <div class="tab-content"> 
                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($mark_emails) && !empty($mark_emails)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo site_url('exam/mail/view/'.$obj->id); ?>" class="btn btn-success btn-xs"><i class="fa fa-eye"></i> <?php echo $this->lang->line('view'); ?> </a>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_send_email">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('exam/mail/send'), array('name' => 'sendemail', 'id' => 'sendemail', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="subject"  id="subject" value="" placeholder="<?php echo $this->lang->line('email'); ?> <?php echo $this->lang->line('subject'); ?>" required="required" type="text">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control" name="note" id="note" placeholder="<?php echo $this->lang->line('note'); ?>"></textarea>
                         ...
                         <?php if(isset($detail)){ ?>
                        <div class="tab-pane fade in active" id="tab_view_send_email">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('exam/mail'), array('', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                
                                <div class="item form-group">
                                    <label class="col-md-3 col-sm-3 col-xs-4"><?php echo $this->lang->line('session_year'); ?></label>
                                    <div class="col-md-9 col-sm-9 col-xs-8">
                                    : <?php echo $mail->session_year; ?>
                                    </div>
                                </div>
                                <div class="item form-group">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-8">
                                    : <?php echo $mail->class_name; ?>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="col-md-3 col-sm-3 col-xs-4"><?php echo $this->lang->line('receiver_type'); ?></label>
                                    <div class="col-md-9 col-sm-9 col-xs-8">
                                    : <?php echo $mail->receiver_type; ?>
                                    </div>
                                </div>
                                                        
                                <div class="item form-group">
                                    <label class="col-md-3 col-sm-3 col-xs-4"><?php echo $this->lang->line('email'); ?> <?php echo $this->lang->line('subject'); ?></label>
                                    <div class="col-md-9 col-sm-9 col-xs-8">
                                ...
                                <div class="item form-group">
                                    <label class="col-md-3 col-sm-3 col-xs-4"><?php echo $this->lang->line('send'); ?> <?php echo $this->lang->line('date'); ?></label>
                                    <div class="col-md-9 col-sm-9 col-xs-8">
                                    : <?php echo date('M j, Y', strtotime($mail->created_at)); ?>
                                    </div>
                                </div>  
