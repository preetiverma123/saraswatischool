            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <div class="tab-content">
                                    ...
                                    <tbody>   
                                        <?php $count = 1; if(isset($schedules) && !empty($schedules)){ ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo date('M j, Y', strtotime($obj->exam_date)); ?></td>
                                                ...
                                                <td>
                                                    ...
                                                    <?php } ?>
                                                    <?php if(has_permission(VIEW, 'exam', 'schedule')){ ?>
                                                        <a href="<?php echo site_url('exam/schedule/view/'.$obj->id); ?>" class="btn btn-success btn-xs"><i class="fa fa-eye"></i> <?php echo $this->lang->line('view'); ?> </a>
                                                    <?php } ?>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('exam/schedule/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="exam_date"  id="add_exam_date" value="<?php echo isset($post['exam_date']) ?  $post['exam_date'] : ''; ?>" placeholder="<?php echo $this->lang->line('exam'); ?> <?php echo $this->lang->line('date'); ?>" required="required" type="text">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="start_time"  id="add_start_time" value="<?php echo isset($post['start_time']) ?  $post['start_time'] : ''; ?>" placeholder="<?php echo $this->lang->line('start_time'); ?>" required="required" type="text">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="end_time"  id="add_end_time" value="<?php echo isset($post['end_time']) ?  $post['end_time'] : ''; ?>" placeholder="<?php echo $this->lang->line('end_time'); ?>" required="required" type="text">
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('exam/schedule/edit/'.$schedule->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="exam_date"  id="edit_exam_date" value="<?php echo isset($schedule->exam_date) ?  date('d-m-Y', strtotime($schedule->exam_date)) : $post['exam_date']; ?>" placeholder="<?php echo $this->lang->line('exam'); ?> <?php echo $this->lang->line('date'); ?>" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('exam_date'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="start_time"  id="edit_start_time" value="<?php echo isset($schedule->start_time) ?  $schedule->start_time : $post['start_time']; ?>" placeholder="<?php echo $this->lang->line('start_time'); ?>" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('start_time'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="end_time"  id="edit_end_time" value="<?php echo isset($schedule->end_time) ?  $schedule->end_time : $post['end_time']; ?>" placeholder="<?php echo $this->lang->line('end_time'); ?>" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('end_time'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
                        ...
                        <?php if(isset($detail)){ ?>
                        <div class="tab-pane fade in active" id="tab_view_schedule">
                            <div class="x_content"> 
                               <?php echo form_open(site_url(), array('name' => 'detail', 'id' => 'detail', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                 
                                <div class="item form-group">
                                    <label class="col-md-3 col-sm-3 col-xs-4"><?php echo $this->lang->line('exam_term'); ?></label>
                                ...
                                <div class="item form-group">
                                    <label class="col-md-3 col-sm-3 col-xs-4"><?php echo $this->lang->line('exam'); ?> <?php echo $this->lang->line('date'); ?></label>
                                    <div class="col-md-9 col-sm-9 col-xs-8">                                        
                                    : <?php echo date('M j,Y', strtotime($schedule->exam_date)); ?>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="col-md-3 col-sm-3 col-xs-4"><?php echo $this->lang->line('start_time'); ?></label>
                                    <div class="col-md-9 col-sm-9 col-xs-8">                                        
                                    : <?php echo $schedule->start_time; ?>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="col-md-3 col-sm-3 col-xs-4"><?php echo $this->lang->line('end_time'); ?></label>
                                    <div class="col-md-9 col-sm-9 col-xs-8">                                        
                                ...
                                <?php if(has_permission(EDIT, 'exam', 'schedule')){ ?>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            <a  href="<?php echo site_url('exam/schedule/edit/'.$schedule->id); ?>"  class="btn btn-primary"><?php echo $this->lang->line('update'); ?></a>
                                        </div>
                                    </div>
                                <?php } ?>
                                <?php echo form_close(); ?>
